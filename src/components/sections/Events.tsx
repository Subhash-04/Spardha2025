          ...
          {eventDays.map((day, dayIndex) => (
            ...
            >
              ...
              <div className="text-center mb-12">
                <motion.div
                  className="inline-flex items-center space-x-4 glass-card px-8 py-4 mb-4"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {day.events.map((event, eventIndex) => (
                  <motion.div
                    ...
                    viewport={{ once: true }}
                  >
                    <div className="neu-card p-6 h-full relative overflow-hidden">
                      {/* Background Pattern */}
        ...
        >
          <div className="glass-card p-8 max-w-2xl mx-auto">
            ...
            <motion.button
              ...
              className="glass-button px-8 py-3 text-lg glow-hover"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
            >
              Register Now
